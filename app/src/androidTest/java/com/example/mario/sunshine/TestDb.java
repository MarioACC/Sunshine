...
import com.example.mario.sunshine.data.WeatherContract.LocationEntry;
import com.example.mario.sunshine.data.WeatherContract.WeatherEntry;
import com.example.mario.sunshine.data.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    public void testInsertReadDb() {
        ...
        String testWeatherDateText="20141205";
        String testWeatherShortDesc= "Asteroids";
        ...
        weatherValues.put(WeatherEntry.COLUMN_DATETEXT,testWeatherDateText);
        weatherValues.put(WeatherEntry.COLUMN_DEGREES, 1.1);
        weatherValues.put(WeatherEntry.COLUMN_HUMIDITY, 1.2);
        weatherValues.put(WeatherEntry.COLUMN_PRESSURE, 1.3);
        weatherValues.put(WeatherEntry.COLUMN_MAX_TEMP, 75);
        weatherValues.put(WeatherEntry.COLUMN_MIN_TEMP, 65);
        weatherValues.put(WeatherEntry.COLUMN_SHORT_DESC,testWeatherShortDesc);
        ...
        if(weatherCursor.moveToFirst()){
            // Get the value in each column by finding the appropriate column index.
            int weatherDateText=weatherCursor.getColumnIndex(WeatherEntry.COLUMN_DATETEXT);
            String dateText=weatherCursor.getString(weatherDateText);

            int weatherShortDesc=weatherCursor.getColumnIndex(WeatherEntry.COLUMN_SHORT_DESC);
            String shortDesc=weatherCursor.getString(weatherShortDesc);

            assertEquals(testWeatherDateText,dateText);
            assertEquals(testWeatherShortDesc,shortDesc);
